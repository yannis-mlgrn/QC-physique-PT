...
\begin{enumerate}[label=\arabic{enumi} - , left=0pt, itemsep=1em] % Personnalisation de la numérotation
    ...
    \begin{solution}\\
        ...
        - Bouclage entre $E^-$ et S et $E^+$ et S, le bouclage fonctionne en régimé linéaire.
    ...
    \item Donner le schéma du montage et la relation entre e et s d'un amplificateur intégrateur de gain  $\infty$  en régime linéaire. \par
    \begin{solution}\\
        Cf cours III.4
    \end{solution}

    \item Donner le schéma du montage et la relation entre e et s d'un suiveur de gain  $\infty$  en régime linéaire. \par
    \begin{solution}\\
        Cf cours III.5
    \end{solution}
